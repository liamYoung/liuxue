...
#import "HXMessageTableViewCell2.h"
...
@implementation HXChatViewController2
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    if (self.isTopicMode) {
        [[[HXIMManager manager]anIM] addClients:[NSSet setWithObject:[HXIMManager manager].clientId] toTopicId:self.chatInfo.topicId success:^(NSString *topicId) {
...
- (void)alertView:(UIAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex
{
    if (buttonIndex == 1 && ![[HXAppUtility removeWhitespace:self.alertTextField.text] isEqualToString:@""])
    {
        ...
        if (self.chatInfo.topicOwner) {
            [[[HXIMManager manager]anIM] updateTopic:self.chatInfo.topicId withName:self.alertTextField.text withOwner:self.chatInfo.topicOwner.clientId success:^(NSString *topicId) {
...
- (CGFloat)tableView:(UITableView*)tableView heightForRowAtIndexPath:(NSIndexPath*)indexPath
{
    ...
    if ([self.messagesArray[indexPath.row] isKindOfClass:[NSMutableDictionary class]]) {
        ...
        return [HXMessageTableViewCell2 cellHeightForOwnerName:ownerName
...
- (UITableViewCell*)tableView:(UITableView*)tableView cellForRowAtIndexPath:(NSIndexPath*)indexPath
{
    ...
    {
        static NSString *cellIdentifier = @"chatCell2";
        HXMessageTableViewCell2 *cell = [tableView dequeueReusableCellWithIdentifier:cellIdentifier];
        ...
        if (cell == nil) {
            ...
            cell = [[HXMessageTableViewCell2 alloc]initWithStyle:UITableViewCellStyleDefault
