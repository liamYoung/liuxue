...
@interface HXMessageTableViewCell2 ()
...
@implementation HXMessageTableViewCell2
...
+ (CGFloat)cellHeightForOwnerName:(NSString *)ownerName message:(NSString *)message messageType:(NSString *)messageType image:(NSData *)image
{
    ...
    }else if ([messageType isEqualToString:@"location"] || [messageType isEqualToString:@"record"])
    {
        ...
        UIImageView *binaryImage = [HXMessageTableViewCell2 resizedPhotoImageView:[[UIImageView alloc]initWithImage:[UIImage imageWithData:image]]];
        if (ownerName) {
...
- (UIImage *)binaryImage
{
    if ([self.messageType isEqualToString:@"location"]) {
        ...
        return [HXMessageTableViewCell2 resizedImage:image];
    }
...
- (UIImageView *)binaryImageView
{
    if ([self.messageType isEqualToString:@"location"]) {
        ...
        return [HXMessageTableViewCell2 resizedPhotoImageView:imageView];
    }
